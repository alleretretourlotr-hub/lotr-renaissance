...
/** GENERE (mega-lot Phase 4) - port de lotr.common.entity.npc.LOTREntityUmbarWarrior */
public class LOTREntityUmbarWarrior extends LOTREntityNPC {

    public LOTREntityUmbarWarrior(EntityType<? extends LOTREntityUmbarWarrior> type, World world) {
        super(type, world);
    }
    ...
    /** PORT de onSpawnWithEgg (Legacy LOTREntityUmbarWarrior) : pool d'armes + armure exacts. */
