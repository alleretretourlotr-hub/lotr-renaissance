...
/** GENERE - PNJ HIGH_ELF. */
public class LOTREntityHighElfWarrior extends LOTREntityNPC {

    public LOTREntityHighElfWarrior(EntityType<? extends LOTREntityHighElfWarrior> type, World world) {
        super(type, world);
    }
