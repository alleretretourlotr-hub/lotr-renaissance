...
/** GENERE (lot marchands) - table Legacy BLUE_DWARF_SMITH */
public class LOTREntityBlueMountainsSmith extends LOTREntityNPC {

    public LOTREntityBlueMountainsSmith(EntityType<? extends LOTREntityBlueMountainsSmith> type, World world) {
        super(type, world);
    }
            ...
            player.openMenu(new INamedContainerProvider() {
                ...
                public Container createMenu(int id, net.minecraft.entity.player.PlayerInventory inv,
                    ...
                    return new LOTRContainerTrade(id, inv,
                            LOTRTradeTables.blueMountainsSmithBuy(),
                            LOTRTradeTables.blueMountainsSmithSell());
                }
            });
        }
