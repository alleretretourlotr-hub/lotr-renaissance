...
/** GENERE PAR L'USINE (lot civils elfes) - port de lotr.common.entity.npc.LOTREntityRivendellElf */
public class LOTREntityRivendellElf extends LOTREntityNPC {

    public LOTREntityRivendellElf(EntityType<? extends LOTREntityRivendellElf> type, World world) {
        super(type, world);
    }
    ...
    /** PORT de onSpawnWithEgg (Legacy LOTREntityRivendellElf). */
