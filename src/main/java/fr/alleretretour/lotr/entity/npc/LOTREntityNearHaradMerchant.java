...
/** GENERE (lot marchands) - table Legacy NEAR_HARAD_MERCHANT */
public class LOTREntityNearHaradMerchant extends LOTREntityNPC {

    public LOTREntityNearHaradMerchant(EntityType<? extends LOTREntityNearHaradMerchant> type, World world) {
        super(type, world);
    }
            ...
            player.openMenu(new INamedContainerProvider() {
                ...
                public Container createMenu(int id, net.minecraft.entity.player.PlayerInventory inv,
                    ...
                    return new LOTRContainerTrade(id, inv,
                            LOTRTradeTables.nearHaradMerchantBuy(),
                            LOTRTradeTables.nearHaradMerchantSell());
                }
            });
        }
