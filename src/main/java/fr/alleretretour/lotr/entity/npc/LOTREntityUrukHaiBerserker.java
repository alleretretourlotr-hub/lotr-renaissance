...
/** GENERE PAR L'USINE (lot 8 ombre) - port de lotr.common.entity.npc.LOTREntityUrukHaiBerserker */
public class LOTREntityUrukHaiBerserker extends LOTREntityNPC {

    public LOTREntityUrukHaiBerserker(EntityType<? extends LOTREntityUrukHaiBerserker> type, World world) {
        super(type, world);
    }
    ...
    /** PORT de onSpawnWithEgg (Legacy LOTREntityUrukHaiBerserker). */
    ...
    public net.minecraft.entity.ILivingEntityData finalizeSpawn(
        ...
        String[] pool = {"lotr:uruk_berserker_scimitar"};
        setItemSlot(net.minecraft.inventory.EquipmentSlotType.MAINHAND,
                stackOf(pool[getRandom().nextInt(pool.length)]));
        setItemSlot(net.minecraft.inventory.EquipmentSlotType.HEAD, stackOf("lotr:uruk_berserker_helmet"));
