...
/** GENERE (mega-lot Phase 4) - port de lotr.common.entity.npc.LOTREntityRangerNorth */
public class LOTREntityRangerNorth extends LOTREntityNPC {

    public LOTREntityRangerNorth(EntityType<? extends LOTREntityRangerNorth> type, World world) {
        super(type, world);
    }
    ...
    /** PORT de onSpawnWithEgg (Legacy LOTREntityRangerNorth) : pool d'armes + armure exacts. */
