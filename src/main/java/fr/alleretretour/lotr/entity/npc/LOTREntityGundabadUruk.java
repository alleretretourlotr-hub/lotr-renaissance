...
/** GENERE (mega-lot Phase 4) - port de lotr.common.entity.npc.LOTREntityGundabadUruk */
public class LOTREntityGundabadUruk extends LOTREntityNPC {

    public LOTREntityGundabadUruk(EntityType<? extends LOTREntityGundabadUruk> type, World world) {
        super(type, world);
    }
    ...
    /** PORT de onSpawnWithEgg (Legacy LOTREntityGundabadUruk) : pool d'armes + armure exacts. */
