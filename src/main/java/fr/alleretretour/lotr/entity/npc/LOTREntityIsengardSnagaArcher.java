...
/** GENERE PAR L'USINE (lot 8 ombre) - port de lotr.common.entity.npc.LOTREntityIsengardSnagaArcher */
public class LOTREntityIsengardSnagaArcher extends LOTREntityNPC {

    public LOTREntityIsengardSnagaArcher(EntityType<? extends LOTREntityIsengardSnagaArcher> type, World world) {
        super(type, world);
    }
    ...
    /** PORT de onSpawnWithEgg (Legacy LOTREntityIsengardSnagaArcher). */
    ...
    public net.minecraft.entity.ILivingEntityData finalizeSpawn(
        ...
        setItemSlot(net.minecraft.inventory.EquipmentSlotType.MAINHAND, stackOf("minecraft:bow"));
