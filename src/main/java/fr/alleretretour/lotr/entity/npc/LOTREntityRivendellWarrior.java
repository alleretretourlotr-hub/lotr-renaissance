...
/** GENERE - PNJ HIGH_ELF. */
public class LOTREntityRivendellWarrior extends LOTREntityNPC {

    public LOTREntityRivendellWarrior(EntityType<? extends LOTREntityRivendellWarrior> type, World world) {
        super(type, world);
    }
    ...
    /** PORT de onSpawnWithEgg (Legacy LOTREntityRivendellWarrior) : pool d'armes + armure exacts. */
