...
/** GENERE (mega-lot Phase 4) - port de lotr.common.entity.npc.LOTREntityBreeGuard */
public class LOTREntityBreeGuard extends LOTREntityNPC {

    public LOTREntityBreeGuard(EntityType<? extends LOTREntityBreeGuard> type, World world) {
        super(type, world);
    }
    ...
    /** PORT de onSpawnWithEgg (Legacy LOTREntityBreeGuard) : pool d'armes + armure exacts. */
