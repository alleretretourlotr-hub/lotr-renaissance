...
/** GENERE (mega-lot Phase 4) - port de lotr.common.entity.npc.LOTREntityDaleLevyman */
public class LOTREntityDaleLevyman extends LOTREntityNPC {

    public LOTREntityDaleLevyman(EntityType<? extends LOTREntityDaleLevyman> type, World world) {
        super(type, world);
    }
    ...
    /** PORT de onSpawnWithEgg (Legacy LOTREntityDaleLevyman) : pool d'armes + armure exacts. */
    ...
    public net.minecraft.entity.ILivingEntityData finalizeSpawn(
        ...
        setItemSlot(net.minecraft.inventory.EquipmentSlotType.CHEST, stackOf("lotr:dale_gambeson_chestplate"));
