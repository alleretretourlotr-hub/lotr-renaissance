...
/** GENERE PAR L'USINE (lot civils elfes) - port de lotr.common.entity.npc.LOTREntityGaladhrimElf */
public class LOTREntityGaladhrimElf extends LOTREntityNPC {

    public LOTREntityGaladhrimElf(EntityType<? extends LOTREntityGaladhrimElf> type, World world) {
        super(type, world);
    }
    ...
    /** PORT de onSpawnWithEgg (Legacy LOTREntityGaladhrimElf). */
