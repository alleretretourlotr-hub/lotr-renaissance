...
/** GENERE PAR L'USINE (lot troupes 3) - port de lotr.common.entity.npc.LOTREntityAngmarHillmanAxeThrower */
public class LOTREntityAngmarHillmanAxeThrower extends LOTREntityNPC {

    public LOTREntityAngmarHillmanAxeThrower(EntityType<? extends LOTREntityAngmarHillmanAxeThrower> type, World world) {
        super(type, world);
    }
    ...
    /** PORT de onSpawnWithEgg (Legacy LOTREntityAngmarHillmanAxeThrower). */
    ...
    public net.minecraft.entity.ILivingEntityData finalizeSpawn(
        ...
        setItemSlot(net.minecraft.inventory.EquipmentSlotType.MAINHAND, stackOf("lotr:iron_throwing_axe"));
