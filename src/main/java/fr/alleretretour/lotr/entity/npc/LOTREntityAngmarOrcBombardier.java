...
/** GENERE PAR L'USINE (lot 8 ombre) - port de lotr.common.entity.npc.LOTREntityAngmarOrcBombardier */
public class LOTREntityAngmarOrcBombardier extends LOTREntityNPC {

    public LOTREntityAngmarOrcBombardier(EntityType<? extends LOTREntityAngmarOrcBombardier> type, World world) {
        super(type, world);
    }
    ...
    /** PORT de onSpawnWithEgg (Legacy LOTREntityAngmarOrcBombardier). */
