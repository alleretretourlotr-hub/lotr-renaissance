...
public class LOTREntityWoodElfScout extends LOTREntityNPC {
    ...
    /** PORT de onSpawnWithEgg (Legacy LOTREntityWoodElfScout) : pool d'armes + armure exacts. */
    ...
    public net.minecraft.entity.ILivingEntityData finalizeSpawn(
        ...
        setItemSlot(net.minecraft.inventory.EquipmentSlotType.HEAD, stackOf("lotr:wood_elven_scout_helmet"));
        setItemSlot(net.minecraft.inventory.EquipmentSlotType.CHEST, stackOf("lotr:wood_elven_scout_chestplate"));
        setItemSlot(net.minecraft.inventory.EquipmentSlotType.LEGS, stackOf("lotr:wood_elven_scout_leggings"));
        setItemSlot(net.minecraft.inventory.EquipmentSlotType.FEET, stackOf("lotr:wood_elven_scout_boots"));
