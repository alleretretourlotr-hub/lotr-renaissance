...
/** GENERE (lot marchands) - table Legacy DALE_BLACKSMITH */
public class LOTREntityDaleBlacksmith extends LOTREntityNPC {

    public LOTREntityDaleBlacksmith(EntityType<? extends LOTREntityDaleBlacksmith> type, World world) {
        super(type, world);
    }
            ...
            player.openMenu(new INamedContainerProvider() {
                ...
                public Container createMenu(int id, net.minecraft.entity.player.PlayerInventory inv,
                    ...
                    return new LOTRContainerTrade(id, inv,
                            LOTRTradeTables.daleBlacksmithBuy(),
                            LOTRTradeTables.daleBlacksmithSell());
                }
            });
        }
