...
/** GENERE (mega-lot Phase 4) - port de lotr.common.entity.npc.LOTREntityTauredainBlowgunner */
public class LOTREntityTauredainBlowgunner extends LOTREntityNPC {

    public LOTREntityTauredainBlowgunner(EntityType<? extends LOTREntityTauredainBlowgunner> type, World world) {
        super(type, world);
    }
    ...
    /** PORT de onSpawnWithEgg (Legacy LOTREntityTauredainBlowgunner) : pool d'armes + armure exacts. */
    ...
    public net.minecraft.entity.ILivingEntityData finalizeSpawn(
        ...
        setItemSlot(net.minecraft.inventory.EquipmentSlotType.MAINHAND, stackOf("lotr:tauredain_blowgun"));
