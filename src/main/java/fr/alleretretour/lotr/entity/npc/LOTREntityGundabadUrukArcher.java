...
/** GENERE PAR L'USINE (lot 8 ombre) - port de lotr.common.entity.npc.LOTREntityGundabadUrukArcher */
public class LOTREntityGundabadUrukArcher extends LOTREntityNPC {

    public LOTREntityGundabadUrukArcher(EntityType<? extends LOTREntityGundabadUrukArcher> type, World world) {
        super(type, world);
    }
    ...
    /** PORT de onSpawnWithEgg (Legacy LOTREntityGundabadUrukArcher). */
    ...
    public net.minecraft.entity.ILivingEntityData finalizeSpawn(
        ...
        setItemSlot(net.minecraft.inventory.EquipmentSlotType.MAINHAND, stackOf("lotr:gundabad_uruk_bow"));
