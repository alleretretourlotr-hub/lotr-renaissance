...
/** GENERE (mega-lot Phase 4) - port de lotr.common.entity.npc.LOTREntityHalfTrollWarrior */
public class LOTREntityHalfTrollWarrior extends LOTREntityNPC {

    public LOTREntityHalfTrollWarrior(EntityType<? extends LOTREntityHalfTrollWarrior> type, World world) {
        super(type, world);
    }
    ...
    /** PORT de onSpawnWithEgg (Legacy LOTREntityHalfTrollWarrior) : pool d'armes + armure exacts. */
    ...
    public net.minecraft.entity.ILivingEntityData finalizeSpawn(
        ...
        String[] pool = {"lotr:half_troll_battleaxe", "lotr:half_troll_hammer", "lotr:half_troll_mace", "lotr:half_troll_scimitar", "lotr:half_troll_dagger", "lotr:half_troll_poisoned_dagger", "lotr:half_troll_pike"};
        setItemSlot(net.minecraft.inventory.EquipmentSlotType.MAINHAND,
                stackOf(pool[getRandom().nextInt(pool.length)]));
        setItemSlot(net.minecraft.inventory.EquipmentSlotType.HEAD, stackOf("lotr:half_troll_helmet"));
        setItemSlot(net.minecraft.inventory.EquipmentSlotType.CHEST, stackOf("lotr:half_troll_chestplate"));
        setItemSlot(net.minecraft.inventory.EquipmentSlotType.LEGS, stackOf("lotr:half_troll_leggings"));
        setItemSlot(net.minecraft.inventory.EquipmentSlotType.FEET, stackOf("lotr:half_troll_boots"));
