...
/** GENERE PAR L'USINE v2 - recruteur, port de LOTREntityRangerIthilienCaptain (table RANGER_ITHILIEN_CAPTAIN) */
public class LOTREntityRangerIthilienCaptain extends LOTREntityNPC {

    public LOTREntityRangerIthilienCaptain(EntityType<? extends LOTREntityRangerIthilienCaptain> type, World world) {
        super(type, world);
    }
    ...
    protected net.minecraft.util.ActionResultType mobInteract(
        ...
        if (hand == net.minecraft.util.Hand.MAIN_HAND && !player.isShiftKeyDown()) {
            ...
            if (alignment < fr.alleretretour.lotr.hire.LOTRHireRosters.RANGERITHILIENCAPTAIN_BASE) {
                return super.mobInteract(player, hand);
            }
            if (!level.isClientSide
                    && player instanceof net.minecraft.entity.player.ServerPlayerEntity) {
                final LOTREntityRangerIthilienCaptain self = this;
                player.openMenu(new net.minecraft.inventory.container.INamedContainerProvider() {
                    ...
                    public net.minecraft.inventory.container.Container createMenu(
                        ...
                        return new fr.alleretretour.lotr.inventory.LOTRContainerHire(id, inv,
                                fr.alleretretour.lotr.hire.LOTRHireRosters.rangerIthilienCaptain(), self);
                    }
                });
            }
    ...
    public net.minecraft.entity.ILivingEntityData finalizeSpawn(
        ...
        setItemSlot(net.minecraft.inventory.EquipmentSlotType.HEAD, stackOf("lotr:ranger_ithilien_helmet"));
        setItemSlot(net.minecraft.inventory.EquipmentSlotType.CHEST, stackOf("lotr:ranger_ithilien_chestplate"));
        setItemSlot(net.minecraft.inventory.EquipmentSlotType.LEGS, stackOf("lotr:ranger_ithilien_leggings"));
        setItemSlot(net.minecraft.inventory.EquipmentSlotType.FEET, stackOf("lotr:ranger_ithilien_boots"));
