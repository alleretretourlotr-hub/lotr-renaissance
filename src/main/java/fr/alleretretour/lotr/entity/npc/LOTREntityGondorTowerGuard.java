...
public class LOTREntityGondorTowerGuard extends LOTREntityNPC {
    ...
    /** PORT de onSpawnWithEgg (Legacy LOTREntityGondorTowerGuard) : pool d'armes + armure exacts. */
    ...
    public net.minecraft.entity.ILivingEntityData finalizeSpawn(
        ...
        String[] pool = {"lotr:gondor_spear"};
        setItemSlot(net.minecraft.inventory.EquipmentSlotType.MAINHAND,
                stackOf(pool[getRandom().nextInt(pool.length)]));
        setItemSlot(net.minecraft.inventory.EquipmentSlotType.HEAD, stackOf("lotr:gondor_winged_helmet"));
