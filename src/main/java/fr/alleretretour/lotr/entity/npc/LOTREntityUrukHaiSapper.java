...
/** GENERE PAR L'USINE (lot 8 ombre) - port de lotr.common.entity.npc.LOTREntityUrukHaiSapper */
public class LOTREntityUrukHaiSapper extends LOTREntityNPC {

    public LOTREntityUrukHaiSapper(EntityType<? extends LOTREntityUrukHaiSapper> type, World world) {
        super(type, world);
    }
    ...
    /** PORT de onSpawnWithEgg (Legacy LOTREntityUrukHaiSapper). */
