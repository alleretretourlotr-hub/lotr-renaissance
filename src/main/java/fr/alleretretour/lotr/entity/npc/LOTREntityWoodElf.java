...
/** GENERE PAR L'USINE (lot 8 ombre) - port de lotr.common.entity.npc.LOTREntityWoodElf */
public class LOTREntityWoodElf extends LOTREntityNPC {

    public LOTREntityWoodElf(EntityType<? extends LOTREntityWoodElf> type, World world) {
        super(type, world);
    }
    ...
    /** PORT de onSpawnWithEgg (Legacy LOTREntityWoodElf). */
