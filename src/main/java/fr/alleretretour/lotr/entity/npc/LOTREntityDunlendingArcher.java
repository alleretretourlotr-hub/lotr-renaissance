...
/** GENERE PAR L'USINE (lot troupes 3) - port de lotr.common.entity.npc.LOTREntityDunlendingArcher */
public class LOTREntityDunlendingArcher extends LOTREntityNPC {

    public LOTREntityDunlendingArcher(EntityType<? extends LOTREntityDunlendingArcher> type, World world) {
        super(type, world);
    }
    ...
    /** PORT de onSpawnWithEgg (Legacy LOTREntityDunlendingArcher). */
