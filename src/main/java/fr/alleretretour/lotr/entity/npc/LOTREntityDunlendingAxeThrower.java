...
/** GENERE PAR L'USINE (lot troupes 3) - port de lotr.common.entity.npc.LOTREntityDunlendingAxeThrower */
public class LOTREntityDunlendingAxeThrower extends LOTREntityNPC {

    public LOTREntityDunlendingAxeThrower(EntityType<? extends LOTREntityDunlendingAxeThrower> type, World world) {
        super(type, world);
    }
    ...
    /** PORT de onSpawnWithEgg (Legacy LOTREntityDunlendingAxeThrower). */
