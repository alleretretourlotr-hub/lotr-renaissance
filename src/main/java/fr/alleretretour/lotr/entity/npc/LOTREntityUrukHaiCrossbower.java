...
public class LOTREntityUrukHaiCrossbower extends LOTREntityNPC {

    public LOTREntityUrukHaiCrossbower(EntityType<? extends LOTREntityUrukHaiCrossbower> type, World world) {
        super(type, world);
    }
    ...
    /** PORT de onSpawnWithEgg (Legacy LOTREntityUrukHaiCrossbower) : pool d'armes + armure exacts. */
    ...
    public net.minecraft.entity.ILivingEntityData finalizeSpawn(
        ...
        setItemSlot(net.minecraft.inventory.EquipmentSlotType.MAINHAND, stackOf("lotr:uruk_crossbow"));
