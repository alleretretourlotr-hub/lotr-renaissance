...
public class LOTREntityRohirrimArcher extends LOTREntityNPC {
    ...
    /** PORT de onSpawnWithEgg (Legacy LOTREntityRohirrimArcher) : pool d'armes + armure exacts. */
    ...
    public net.minecraft.entity.ILivingEntityData finalizeSpawn(
        ...
        setItemSlot(net.minecraft.inventory.EquipmentSlotType.MAINHAND, stackOf("lotr:rohan_bow"));
