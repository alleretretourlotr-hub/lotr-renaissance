...
/** GENERE (mega-lot Phase 4) - port de lotr.common.entity.npc.LOTREntityHobbitBounder */
public class LOTREntityHobbitBounder extends LOTREntityNPC {

    public LOTREntityHobbitBounder(EntityType<? extends LOTREntityHobbitBounder> type, World world) {
        super(type, world);
    }
    ...
    /** PORT de onSpawnWithEgg (Legacy LOTREntityHobbitBounder) : pool d'armes + armure exacts. */
