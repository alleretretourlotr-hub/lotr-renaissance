...
/** GENERE (mega-lot Phase 4) - port de lotr.common.entity.npc.LOTREntityDunlendingBerserker */
public class LOTREntityDunlendingBerserker extends LOTREntityNPC {

    public LOTREntityDunlendingBerserker(EntityType<? extends LOTREntityDunlendingBerserker> type, World world) {
        super(type, world);
    }
    ...
    /** PORT de onSpawnWithEgg (Legacy LOTREntityDunlendingBerserker) : pool d'armes + armure exacts. */
    ...
    public net.minecraft.entity.ILivingEntityData finalizeSpawn(
        ...
        String[] pool = {"lotr:bronze_battleaxe"};
        ...
        setItemSlot(net.minecraft.inventory.EquipmentSlotType.CHEST, stackOf("lotr:bone_chestplate"));
