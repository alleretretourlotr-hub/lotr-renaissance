...
/** GENERE (mega-lot Phase 4) - port de lotr.common.entity.npc.LOTREntityBlueDwarfWarrior */
public class LOTREntityBlueDwarfWarrior extends LOTREntityNPC {

    public LOTREntityBlueDwarfWarrior(EntityType<? extends LOTREntityBlueDwarfWarrior> type, World world) {
        super(type, world);
    }
    ...
    /** PORT de onSpawnWithEgg (Legacy LOTREntityBlueDwarfWarrior) : pool d'armes + armure exacts. */
    ...
    public net.minecraft.entity.ILivingEntityData finalizeSpawn(
        ...
        String[] pool = {"lotr:blue_dwarven_sword", "lotr:blue_dwarven_battleaxe", "lotr:blue_dwarven_hammer", "lotr:blue_dwarven_pike", "lotr:blue_dwarven_spear"};
