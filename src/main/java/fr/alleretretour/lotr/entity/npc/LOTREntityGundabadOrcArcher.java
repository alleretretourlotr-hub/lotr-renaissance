...
/** GENERE (mega-lot Phase 4) - port de lotr.common.entity.npc.LOTREntityGundabadOrcArcher */
public class LOTREntityGundabadOrcArcher extends LOTREntityNPC {

    public LOTREntityGundabadOrcArcher(EntityType<? extends LOTREntityGundabadOrcArcher> type, World world) {
        super(type, world);
    }
    ...
    /** PORT de onSpawnWithEgg (Legacy LOTREntityGundabadOrcArcher) : pool d'armes + armure exacts. */
    ...
    public net.minecraft.entity.ILivingEntityData finalizeSpawn(
        ...
        setItemSlot(net.minecraft.inventory.EquipmentSlotType.MAINHAND, stackOf("lotr:iron_crossbow"));
