...
/** GENERE (mega-lot Phase 4) - port de lotr.common.entity.npc.LOTREntityDorwinionElfWarrior */
public class LOTREntityDorwinionElfWarrior extends LOTREntityNPC {

    public LOTREntityDorwinionElfWarrior(EntityType<? extends LOTREntityDorwinionElfWarrior> type, World world) {
        super(type, world);
    }
    ...
    /** PORT de onSpawnWithEgg (Legacy LOTREntityDorwinionElfWarrior) : pool d'armes + armure exacts. */
    ...
    public net.minecraft.entity.ILivingEntityData finalizeSpawn(
        ...
        String[] pool = {"lotr:dorwinion_elf_sword", "lotr:bladorthin_spear"};
