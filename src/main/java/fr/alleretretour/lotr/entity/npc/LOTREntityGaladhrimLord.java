...
public class LOTREntityGaladhrimLord extends LOTREntityNPC {
    ...
    public ILivingEntityData finalizeSpawn(IServerWorld world, DifficultyInstance difficulty,
        ...
        setItemSlot(EquipmentSlotType.FEET, new ItemStack(itemOf("elven_boots")));
        setItemSlot(EquipmentSlotType.LEGS, new ItemStack(itemOf("elven_leggings")));
        setItemSlot(EquipmentSlotType.CHEST, new ItemStack(itemOf("elven_chestplate")));
        setItemSlot(EquipmentSlotType.HEAD, new ItemStack(itemOf("elven_helmet")));
        setItemSlot(EquipmentSlotType.MAINHAND, new ItemStack(itemOf("elven_sword")));
