...
/** GENERE (mega-lot Phase 4) - port de lotr.common.entity.npc.LOTREntityEasterlingGoldWarrior */
public class LOTREntityEasterlingGoldWarrior extends LOTREntityNPC {

    public LOTREntityEasterlingGoldWarrior(EntityType<? extends LOTREntityEasterlingGoldWarrior> type, World world) {
        super(type, world);
    }
    ...
    /** PORT de onSpawnWithEgg (Legacy LOTREntityEasterlingGoldWarrior) : pool d'armes + armure exacts. */
    ...
    public net.minecraft.entity.ILivingEntityData finalizeSpawn(
        ...
        String[] pool = {"lotr:rhun_sword", "lotr:rhun_battleaxe", "lotr:rhun_polearm", "lotr:rhun_dagger", "lotr:rhun_poisoned_dagger", "lotr:rhun_pike", "lotr:rhun_spear"};
        setItemSlot(net.minecraft.inventory.EquipmentSlotType.MAINHAND,
                stackOf(pool[getRandom().nextInt(pool.length)]));
        setItemSlot(net.minecraft.inventory.EquipmentSlotType.HEAD, stackOf("lotr:rhun_gold_helmet"));
        setItemSlot(net.minecraft.inventory.EquipmentSlotType.CHEST, stackOf("lotr:rhun_gold_chestplate"));
        setItemSlot(net.minecraft.inventory.EquipmentSlotType.LEGS, stackOf("lotr:rhun_gold_leggings"));
        setItemSlot(net.minecraft.inventory.EquipmentSlotType.FEET, stackOf("lotr:rhun_gold_boots"));
