...
/** GENERE PAR L'USINE (mega-lot 2) - port de lotr.common.entity.npc.LOTREntityRangerIthilien */
public class LOTREntityRangerIthilien extends LOTREntityNPC {

    public LOTREntityRangerIthilien(EntityType<? extends LOTREntityRangerIthilien> type, World world) {
        super(type, world);
    }
    ...
    /** PORT de onSpawnWithEgg (Legacy LOTREntityRangerIthilien). */
