...
/** GENERE (mega-lot Phase 4) - port de lotr.common.entity.npc.LOTREntityDolGuldurOrc */
public class LOTREntityDolGuldurOrc extends LOTREntityNPC {

    public LOTREntityDolGuldurOrc(EntityType<? extends LOTREntityDolGuldurOrc> type, World world) {
        super(type, world);
    }
    ...
    /** PORT de onSpawnWithEgg (Legacy LOTREntityDolGuldurOrc) : pool d'armes + armure exacts. */
