...
/** GENERE (mega-lot Phase 4) - port de lotr.common.entity.npc.LOTREntityNearHaradrimArcher */
public class LOTREntityNearHaradrimArcher extends LOTREntityNPC {

    public LOTREntityNearHaradrimArcher(EntityType<? extends LOTREntityNearHaradrimArcher> type, World world) {
        super(type, world);
    }
    ...
    /** PORT de onSpawnWithEgg (Legacy LOTREntityNearHaradrimArcher) : pool d'armes + armure exacts. */
