...
/** GENERE (lot marchands) - table Legacy DOL_GULDUR_TRADER */
public class LOTREntityDolGuldurOrcTrader extends LOTREntityNPC {

    public LOTREntityDolGuldurOrcTrader(EntityType<? extends LOTREntityDolGuldurOrcTrader> type, World world) {
        super(type, world);
    }
            ...
            player.openMenu(new INamedContainerProvider() {
                ...
                public Container createMenu(int id, net.minecraft.entity.player.PlayerInventory inv,
                    ...
                    return new LOTRContainerTrade(id, inv,
                            LOTRTradeTables.dolGuldurOrcTraderBuy(),
                            LOTRTradeTables.dolGuldurOrcTraderSell());
                }
            });
        }
