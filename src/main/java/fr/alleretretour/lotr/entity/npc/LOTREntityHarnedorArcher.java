...
/** GENERE PAR L'USINE (mega-lot 2) - port de lotr.common.entity.npc.LOTREntityHarnedorArcher */
public class LOTREntityHarnedorArcher extends LOTREntityNPC {

    public LOTREntityHarnedorArcher(EntityType<? extends LOTREntityHarnedorArcher> type, World world) {
        super(type, world);
    }
    ...
    /** PORT de onSpawnWithEgg (Legacy LOTREntityHarnedorArcher). */
