...
/** GENERE (mega-lot Phase 4) - port de lotr.common.entity.npc.LOTREntityEasterlingArcher */
public class LOTREntityEasterlingArcher extends LOTREntityNPC {

    public LOTREntityEasterlingArcher(EntityType<? extends LOTREntityEasterlingArcher> type, World world) {
        super(type, world);
    }
    ...
    /** PORT de onSpawnWithEgg (Legacy LOTREntityEasterlingArcher) : pool d'armes + armure exacts. */
    ...
    public net.minecraft.entity.ILivingEntityData finalizeSpawn(
        ...
        setItemSlot(net.minecraft.inventory.EquipmentSlotType.MAINHAND, stackOf("lotr:rhun_bow"));
