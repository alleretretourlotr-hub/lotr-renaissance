...
/** GENERE PAR L'USINE (lot 8 ombre) - port de lotr.common.entity.npc.LOTREntityMordorOrcBombardier */
public class LOTREntityMordorOrcBombardier extends LOTREntityNPC {

    public LOTREntityMordorOrcBombardier(EntityType<? extends LOTREntityMordorOrcBombardier> type, World world) {
        super(type, world);
    }
    ...
    /** PORT de onSpawnWithEgg (Legacy LOTREntityMordorOrcBombardier). */
