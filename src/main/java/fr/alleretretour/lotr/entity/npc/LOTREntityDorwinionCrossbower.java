...
public class LOTREntityDorwinionCrossbower extends LOTREntityNPC {

    public LOTREntityDorwinionCrossbower(EntityType<? extends LOTREntityDorwinionCrossbower> type, World world) {
        super(type, world);
    }
    ...
    /** PORT de onSpawnWithEgg (Legacy LOTREntityDorwinionCrossbower) : pool d'armes + armure exacts. */
