...
/** GENERE PAR L'USINE (lot troupes 3) - port de lotr.common.entity.npc.LOTREntitySouthronChampion */
public class LOTREntitySouthronChampion extends LOTREntityNPC {

    public LOTREntitySouthronChampion(EntityType<? extends LOTREntitySouthronChampion> type, World world) {
        super(type, world);
    }
    ...
    /** PORT de onSpawnWithEgg (Legacy LOTREntitySouthronChampion). */
    ...
    public net.minecraft.entity.ILivingEntityData finalizeSpawn(
        ...
        String[] pool = {"lotr:near_harad_spear"};
