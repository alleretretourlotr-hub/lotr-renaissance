...
/** GENERE (lot marchands) - table Legacy DWARF_SMITH */
public class LOTREntityDwarfSmith extends LOTREntityNPC {

    public LOTREntityDwarfSmith(EntityType<? extends LOTREntityDwarfSmith> type, World world) {
        super(type, world);
    }
            ...
            player.openMenu(new INamedContainerProvider() {
                ...
                public Container createMenu(int id, net.minecraft.entity.player.PlayerInventory inv,
                    ...
                    return new LOTRContainerTrade(id, inv,
                            LOTRTradeTables.dwarfSmithBuy(),
                            LOTRTradeTables.dwarfSmithSell());
                }
            });
        }
