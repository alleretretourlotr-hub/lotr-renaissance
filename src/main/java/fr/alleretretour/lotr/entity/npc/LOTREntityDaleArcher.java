...
/** GENERE (mega-lot Phase 4) - port de lotr.common.entity.npc.LOTREntityDaleArcher */
public class LOTREntityDaleArcher extends LOTREntityNPC {

    public LOTREntityDaleArcher(EntityType<? extends LOTREntityDaleArcher> type, World world) {
        super(type, world);
    }
    ...
    /** PORT de onSpawnWithEgg (Legacy LOTREntityDaleArcher) : pool d'armes + armure exacts. */
    ...
    public net.minecraft.entity.ILivingEntityData finalizeSpawn(
        ...
        setItemSlot(net.minecraft.inventory.EquipmentSlotType.MAINHAND, stackOf("lotr:dale_bow"));
