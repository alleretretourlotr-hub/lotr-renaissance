...
/** GENERE (mega-lot Phase 4) - port de lotr.common.entity.npc.LOTREntityAngmarOrcArcher */
public class LOTREntityAngmarOrcArcher extends LOTREntityNPC {

    public LOTREntityAngmarOrcArcher(EntityType<? extends LOTREntityAngmarOrcArcher> type, World world) {
        super(type, world);
    }
    ...
    /** PORT de onSpawnWithEgg (Legacy LOTREntityAngmarOrcArcher) : pool d'armes + armure exacts. */
