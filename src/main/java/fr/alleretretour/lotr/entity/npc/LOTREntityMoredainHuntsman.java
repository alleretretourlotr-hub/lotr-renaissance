...
/** GENERE (mega-lot Phase 4) - port de lotr.common.entity.npc.LOTREntityMoredainHuntsman */
public class LOTREntityMoredainHuntsman extends LOTREntityNPC {

    public LOTREntityMoredainHuntsman(EntityType<? extends LOTREntityMoredainHuntsman> type, World world) {
        super(type, world);
    }
    ...
    /** PORT de onSpawnWithEgg (Legacy LOTREntityMoredainHuntsman) : pool d'armes + armure exacts. */
