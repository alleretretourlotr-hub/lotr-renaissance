...
/** GENERE (mega-lot Phase 4) - port de lotr.common.entity.npc.LOTREntityTauredainWarrior */
public class LOTREntityTauredainWarrior extends LOTREntityNPC {

    public LOTREntityTauredainWarrior(EntityType<? extends LOTREntityTauredainWarrior> type, World world) {
        super(type, world);
    }
    ...
    /** PORT de onSpawnWithEgg (Legacy LOTREntityTauredainWarrior) : pool d'armes + armure exacts. */
    ...
    public net.minecraft.entity.ILivingEntityData finalizeSpawn(
        ...
        String[] pool = {"lotr:tauredain_sword", "lotr:tauredain_dagger", "lotr:tauredain_poisoned_dagger", "lotr:tauredain_hammer", "lotr:tauredain_battleaxe", "lotr:tauredain_pike", "lotr:tauredain_spear"};
        setItemSlot(net.minecraft.inventory.EquipmentSlotType.MAINHAND,
                stackOf(pool[getRandom().nextInt(pool.length)]));
        setItemSlot(net.minecraft.inventory.EquipmentSlotType.HEAD, stackOf("lotr:tauredain_helmet"));
        setItemSlot(net.minecraft.inventory.EquipmentSlotType.CHEST, stackOf("lotr:tauredain_chestplate"));
        setItemSlot(net.minecraft.inventory.EquipmentSlotType.LEGS, stackOf("lotr:tauredain_leggings"));
        setItemSlot(net.minecraft.inventory.EquipmentSlotType.FEET, stackOf("lotr:tauredain_boots"));
