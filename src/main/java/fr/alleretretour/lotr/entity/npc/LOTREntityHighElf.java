...
/** GENERE PAR L'USINE (lot civils elfes) - port de lotr.common.entity.npc.LOTREntityHighElf */
public class LOTREntityHighElf extends LOTREntityNPC {

    public LOTREntityHighElf(EntityType<? extends LOTREntityHighElf> type, World world) {
        super(type, world);
    }
    ...
    /** PORT de onSpawnWithEgg (Legacy LOTREntityHighElf). */
