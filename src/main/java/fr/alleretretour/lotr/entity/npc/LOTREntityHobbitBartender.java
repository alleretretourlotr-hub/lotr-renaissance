...
/** GENERE (lot marchands) - table Legacy HOBBIT_BARTENDER */
public class LOTREntityHobbitBartender extends LOTREntityNPC {

    public LOTREntityHobbitBartender(EntityType<? extends LOTREntityHobbitBartender> type, World world) {
        super(type, world);
    }
            ...
            player.openMenu(new INamedContainerProvider() {
                ...
                public Container createMenu(int id, net.minecraft.entity.player.PlayerInventory inv,
                    ...
                    return new LOTRContainerTrade(id, inv,
                            LOTRTradeTables.hobbitBartenderBuy(),
                            LOTRTradeTables.hobbitBartenderSell());
                }
            });
        }
