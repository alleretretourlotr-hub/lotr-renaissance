...
/** GENERE (lot marchands) - table Legacy BREE_INNKEEPER */
public class LOTREntityBreeInnkeeper extends LOTREntityNPC {

    public LOTREntityBreeInnkeeper(EntityType<? extends LOTREntityBreeInnkeeper> type, World world) {
        super(type, world);
    }
            ...
            player.openMenu(new INamedContainerProvider() {
                ...
                public Container createMenu(int id, net.minecraft.entity.player.PlayerInventory inv,
                    ...
                    return new LOTRContainerTrade(id, inv,
                            LOTRTradeTables.breeInnkeeperBuy(),
                            LOTRTradeTables.breeInnkeeperSell());
                }
            });
        }
