...
/** GENERE (mega-lot Phase 4) - port de lotr.common.entity.npc.LOTREntityDunlending */
public class LOTREntityDunlending extends LOTREntityNPC {

    public LOTREntityDunlending(EntityType<? extends LOTREntityDunlending> type, World world) {
        super(type, world);
    }
    ...
    /** PORT de onSpawnWithEgg (Legacy LOTREntityDunlending) : pool d'armes + armure exacts. */
    ...
    public net.minecraft.entity.ILivingEntityData finalizeSpawn(
        ...
        String[] pool = {"minecraft:wooden_sword", "minecraft:stone_sword", "minecraft:stone_axe", "minecraft:stone_hoe", "lotr:stone_spear"};
