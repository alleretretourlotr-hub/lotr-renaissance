...
/** GENERE (mega-lot Phase 4) - port de lotr.common.entity.npc.LOTREntityEasterlingWarrior */
public class LOTREntityEasterlingWarrior extends LOTREntityNPC {

    public LOTREntityEasterlingWarrior(EntityType<? extends LOTREntityEasterlingWarrior> type, World world) {
        super(type, world);
    }
    ...
    /** PORT de onSpawnWithEgg (Legacy LOTREntityEasterlingWarrior) : pool d'armes + armure exacts. */
    ...
    public net.minecraft.entity.ILivingEntityData finalizeSpawn(
        ...
        setItemSlot(net.minecraft.inventory.EquipmentSlotType.HEAD, stackOf("lotr:rhun_helmet"));
        setItemSlot(net.minecraft.inventory.EquipmentSlotType.CHEST, stackOf("lotr:rhun_chestplate"));
        setItemSlot(net.minecraft.inventory.EquipmentSlotType.LEGS, stackOf("lotr:rhun_leggings"));
        setItemSlot(net.minecraft.inventory.EquipmentSlotType.FEET, stackOf("lotr:rhun_boots"));
