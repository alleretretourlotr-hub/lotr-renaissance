...
/** GENERE (mega-lot Phase 4) - port de lotr.common.entity.npc.LOTREntityDorwinionElfArcher */
public class LOTREntityDorwinionElfArcher extends LOTREntityNPC {

    public LOTREntityDorwinionElfArcher(EntityType<? extends LOTREntityDorwinionElfArcher> type, World world) {
        super(type, world);
    }
    ...
    /** PORT de onSpawnWithEgg (Legacy LOTREntityDorwinionElfArcher) : pool d'armes + armure exacts. */
    ...
    public net.minecraft.entity.ILivingEntityData finalizeSpawn(
        ...
        setItemSlot(net.minecraft.inventory.EquipmentSlotType.MAINHAND, stackOf("lotr:dorwinion_elf_bow"));
        setItemSlot(net.minecraft.inventory.EquipmentSlotType.HEAD, stackOf("lotr:dorwinion_elf_helmet"));
        setItemSlot(net.minecraft.inventory.EquipmentSlotType.CHEST, stackOf("lotr:dorwinion_elf_chestplate"));
        setItemSlot(net.minecraft.inventory.EquipmentSlotType.LEGS, stackOf("lotr:dorwinion_elf_leggings"));
        setItemSlot(net.minecraft.inventory.EquipmentSlotType.FEET, stackOf("lotr:dorwinion_elf_boots"));
