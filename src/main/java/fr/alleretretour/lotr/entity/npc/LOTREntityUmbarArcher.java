...
/** GENERE (mega-lot Phase 4) - port de lotr.common.entity.npc.LOTREntityUmbarArcher */
public class LOTREntityUmbarArcher extends LOTREntityNPC {

    public LOTREntityUmbarArcher(EntityType<? extends LOTREntityUmbarArcher> type, World world) {
        super(type, world);
    }
    ...
    /** PORT de onSpawnWithEgg (Legacy LOTREntityUmbarArcher) : pool d'armes + armure exacts. */
