...
/** GENERE (mega-lot Phase 4) - port de lotr.common.entity.npc.LOTREntityDwarfWarrior */
public class LOTREntityDwarfWarrior extends LOTREntityNPC {

    public LOTREntityDwarfWarrior(EntityType<? extends LOTREntityDwarfWarrior> type, World world) {
        super(type, world);
    }
    ...
    /** PORT de onSpawnWithEgg (Legacy LOTREntityDwarfWarrior) : pool d'armes + armure exacts. */
    ...
    public net.minecraft.entity.ILivingEntityData finalizeSpawn(
        ...
        String[] pool = {"lotr:dwarven_sword", "lotr:dwarven_battleaxe", "lotr:dwarven_hammer", "lotr:dwarven_pike", "lotr:dwarven_spear"};
