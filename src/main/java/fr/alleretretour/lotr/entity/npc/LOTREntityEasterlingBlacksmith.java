...
/** GENERE (lot marchands) - table Legacy RHUN_BLACKSMITH */
public class LOTREntityEasterlingBlacksmith extends LOTREntityNPC {

    public LOTREntityEasterlingBlacksmith(EntityType<? extends LOTREntityEasterlingBlacksmith> type, World world) {
        super(type, world);
    }
            ...
            player.openMenu(new INamedContainerProvider() {
                ...
                public Container createMenu(int id, net.minecraft.entity.player.PlayerInventory inv,
                    ...
                    return new LOTRContainerTrade(id, inv,
                            LOTRTradeTables.easterlingBlacksmithBuy(),
                            LOTRTradeTables.easterlingBlacksmithSell());
                }
            });
        }
