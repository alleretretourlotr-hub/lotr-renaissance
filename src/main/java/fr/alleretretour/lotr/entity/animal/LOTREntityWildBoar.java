...
/**
 * PORT de LOTREntityWildBoar : sanglier sauvage (degats 3.0 du Legacy),
 * riposte quand attaque, sert de monture aux unites naines.
 */
public class LOTREntityWildBoar extends AnimalEntity implements LOTRMountArmored {

    public LOTREntityWildBoar(EntityType<? extends LOTREntityWildBoar> type, World world) {
        super(type, world);
    }
    ...
    public AgeableEntity getBreedOffspring(net.minecraft.world.server.ServerWorld world,
        ...
        return fr.alleretretour.lotr.init.LOTREntities.WILD_BOAR.get().create(world);
    }
    ...
    private static final net.minecraft.network.datasync.DataParameter<net.minecraft.item.ItemStack>
            ...
            LOTREntityWildBoar.class, net.minecraft.network.datasync.DataSerializers.ITEM_STACK);
